...
7. This project is a demo i've built in 4 full working days (+1 day to test and record video. total is 5days). So there are some missing points. It can not be a final product. there are a lot functions / features in my mind that i want to build if it's real world. please focus on the demo only.
